...
class DymolaFmuExport(FmuExport):
    ...
    def __init__(self, dymola_exe_path: Union[Path, str], 
        ...
        Args:
            ...
            parameters (dict[str, Union[str, int, float, list, bool]], optional): Dictionary of parameter names and values.
                                    Example:
    ...
    def dymola_exe_path(self, dymola_exe_path: Path) -> None:
        """Sets the Path to the dymola executable.
    ...
    def parameters(self, parameters: dict[str, Union[str, int, float, list, bool]]) -> None:
        """Setter for 'paremeter' property.

        Args:
            parameters (dict[str, Union[str, int, float, list, bool]]): Dictionary of parameter names and values

        Raises:
            TypeError: 'parameters' type was not 'dict' 
            TypeError: type of key in dictionary was not 'str'
            TypeError: type of value in dictionary was not 'str', 'int', 'bool', 'float', 'list'
        """
    ...
    def model_modifiers(self, model_modifiers: list[str]) -> None:
        """Setter for 'model_modifiers' property
    ...
    def export_fmu(self, export_simulator_log: Optional[bool] = True, export_error_log: Optional[bool] = True) -> None:
        """Executes command to export a fmu.
...
def export_dymola_fmu(
    ...
    """This function does the following steps:
        ...
        3. When exporting, multiple unnecessary files will be generated. These files will be deleted.
        4. If the export was successful, all generated files that are to be kept are moved to the specified output directory.
        5. If the export was not successful the model is exported without imported parameters.
        6. If the export without imported parameters was successful a list of parameters is genereted
           that were tried to be imported but are not part of the model.
...
def read_model_parameters(fmu_path: Path) -> list[str]:
    """Reads the models parameters of fmu.
...
def check_not_valid_parameters( imported_parameters: list[str], parameters_in_model: list[str]) -> list[str]:
    """Returns parameters that were tried to be imported but were not part of the model.
...
def extract_error_message(error_log: str) -> str:
    """Extracts the error message of the dymola error dialog. 
